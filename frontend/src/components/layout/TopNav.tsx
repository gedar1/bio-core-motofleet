...
export const TopNav: React.FC = () => {
  ...
  return (
    <nav className="fixed gap-lg left-0 right-0 top-0 z-50 flex h-[64px] items-center justify-between border-b border-hairline-soft bg-canvas lg:px-2xl px-md transition-colors duration-200">
      <Link
      ...
      >
        ...
        <span className="flex gap-sm text-heading-5">
          <span>RYD</span>
      ...
      <div className="flex items-center gap-md lg:gap-xl">
        <button
          type="button"
          onClick={toggle}
          className="flex h-[48px] w-[48px] items-center justify-center text-ink transition-colors"
